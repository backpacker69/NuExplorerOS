...
.controller('AllMotionsController', [ '$scope','$location','wsFactory','mvFactory', 
function($scope,$location,wsFactory,mvFactory) {

    if (wsFactory.ds.xmotion === undefined) {
        wsFactory.ds.onMessage(function(message){
            var data = JSON.parse(message.data);
            if ((data.type === 'block') && location.pathname === '/motions'){
...
function($scope,$location,wsFactory,functionFactory,mvFactory,currencyFactory){
    ...
    if (wsFactory.ds.xvote === undefined) {
        wsFactory.ds.onMessage(function(message){
            var data = JSON.parse(message.data);
            if (data.type === 'block' && location.pathname === '/votes'){
